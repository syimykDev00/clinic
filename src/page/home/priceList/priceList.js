...
import priceImage from './../../../assets/img/price.png'
...
const PriceList = () => {
    ...
    const date = [
        {
            id: 1,
            text: "Нуга Бест массажер",
            price: "200 сом"
        },
        {
            id: 2,
            text: "Лазер - рихта аппарат",
            price: "150 сом"
        },
        {
            id: 3,
        ...
        {
            id: 12,
            text: "Внутривенной иньекции",
            price: "50 сом"
        },
        {
            id: 13,
            text: "Внутримышечной иньекции",
            price: "30 сом"
        },
        {
            id: 14,
            text: "Подкожной иньекции",
            price: "20 сом"
        },
        {
            id: 15,
            text: "Урологический массаж",
            price: "200 сом"
        },
        {
            id: 16,
            text: "Гинекологический массаж",
            price: "200 сом"
        }, {
            id: 17,
            text: "Санация влагалища с мазевым раствором",
            price: "700 сом"
        },
        {
            id: 18,
        ...
        {
            id: 20,
            text: "УЗИ печени и желчного пузыря",
            price: "400 сом"
        },
        {
            id: 21,
        ...
        {
            id: 24,
            text: "Осмотр в зеркалах (одноразовое зеркало)",
            price: "100/300 сом"
        },
        {
            id: 25,
        ...
        {
            id: 26,
            text: "Лечение за 10 дней услуга",
            price: "6600 сом"
        }
    ]
            ...
            <div className="container">
                <div className="priceList">
                    ...
                    <div className="priceList--blocks">
                        ...
                        <div className="priceList--blocks__image">
                            <img src={priceImage} alt="img"/>
                            <div className="priceList--blocks__image--text">
