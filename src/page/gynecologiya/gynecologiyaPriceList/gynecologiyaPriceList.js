...
import gynecologiyaPriceImg from './../../../assets/img/gynecologiyaPriceImg.png'

const gynecologiyaPriceList = () => {

    const date = [
        {
            id: 1,
            text: "Гинекологические операции",
            price: "42 500 сом"
        },
        {
            id: 2,
            text: "Надбавка к двухэтапной операции",
            price: "8 500 сом"
        },
        {
            id: 3,
        ...
        {
            id: 8,
            text: "Дополнительные медицинские расходные материалы",
            price: "2000 сом"
        },
    ]
    ...
    return (
        <section id="gynecologiyaPriceList">
            <div className="container">
                <div className="gynecologiyaPriceList">
                    <h1>Прайс-лист</h1>
                    <p>
                        Доступные цены для всех различных вид услуг
                    </p>
                    <div className="gynecologiyaPriceList--blocks">
                        <div className="gynecologiyaPriceList--blocks__price">
                            {
                                date.map((el) => (
                                    <div className="gynecologiyaPriceList--blocks__price--block">
                                        <h4>{el.id}. {el.text}
                                        ...
                                        <div className="gynecologiyaPriceList--blocks__price--block__line"></div>
                                        <h5>{el.price}</h5>
                                    </div>
                        ...
                        <div className="gynecologiyaPriceList--blocks__image">
                            <img src={gynecologiyaPriceImg} alt="img"/>
                            <div className="gynecologiyaPriceList--blocks__image--text">
...
export default gynecologiyaPriceList;