...
import stomatologyPriceImg from "../../../assets/img/stomatologyPriceImg.png";
...
const date = [
    ...
    {
        id: 2,
        text: "Консультация главного врача",
        price: "300 сом"
    },
    {
        id: 3,
        text: "Консультация главного врача с составлением плана лечения (слепки, модели, фото)",
        price: "1000 сом"
    },
    {
        id: 4,
        text: "Вторичный приём (за каждый визит)",
        price: "40 сом"
    },
    {
        id: 5,
        text: "Отбеливание после эндолечения (1 посещ)",
        price: "500 сом"
    },
    {
        id: 6,
        text: "Установка украшений на зубы (скайсы)",
        price: "500 сом"
    },
    {
        id: 7,
        text: "Домашнее отбеливание Opalescencе",
        price: "4000 сом"
    },
    {
        id: 8,
    ...
    {
        id: 9,
        text: "Периапикальный рентген снимок",
        price: "100 сом"
    },
    {
        id: 10,
        text: "Наложение раббердама, одноразового ретрактора",
        price: "200 сом"
    }
]

const StomatologyPriceList = () => {
    return (
        <section id="stomatologyPriceList">
            <div className="container">
                <div className="stomatologyPriceList">
                    ...
                    <div className="stomatologyPriceList--blocks">
                        <div className="stomatologyPriceList--blocks__price">
                            {
                                date.map((el, idx) => (
                                    <div className="stomatologyPriceList--blocks__price--block">
                                        <h4>
                                            {el.id}. {el.text}
                                        ...
                                        <div className="stomatologyPriceList--blocks__price--block__line"></div>
                                        <h5>{el.price}</h5>
                                    </div>
                                ))
                            }
                        </div>
                        <div className="stomatologyPriceList--blocks__image">
                            <img src={stomatologyPriceImg} alt="img"/>
                            <div className="stomatologyPriceList--blocks__image--text">
...
export default StomatologyPriceList;
