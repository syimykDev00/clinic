...
import orthopedicsImgOne from './../../../assets/img/orthopedicsImgOne.jpg';
import orthopedicsImgTwo from './../../../assets/img/orthopedicsImgTwo.jpg';
...
const OrthopedicsServices = () => {
    ...
    const dateTwo = [
        ...
        {
            id: 2,
            text: "Металлокерамика",
            price: "3000 сом"
        },
        {
            id: 3,
            text: "Позолоченные коронки",
            price: "1000 сом"
        },
        {
            id: 4,
    ...
    return (
        <section id="orthopedicsServices">
            <div className="container">
                <div className="orthopedicsServices">
                    <h1>Прайс-лист</h1>
                    <p>Выбор способа зависит от клинической ситуации пациента</p>
                    <h3>
                        СЪЕМНЫЙ
                    </h3>
                    <div className="orthopedicsServices--blocks">
                        <div className="orthopedicsServices--blocks__price">
                            {
                                dateOne.map((el) => (
                                    <div className="orthopedicsServices--blocks__price--block">
                                        <h4>{el.id}. {el.text}
                                        ...
                                        <div className="orthopedicsServices--blocks__price--block__line"></div>
                                        <h5>{el.price}</h5>
                                    </div>
                    ...
                    <center>
                        <img src={orthopedicsImgOne} alt="img"/>
                    </center>
                    <h3>HEСЪЕМНЫЙ</h3>
                    <div className="orthopedicsServices--blocks">
                        <div className="orthopedicsServices--blocks__price">
                    ...
                    <center>
                        <img src={orthopedicsImgTwo} alt="img"/>
                    </center>
                </div>
            </div>
        </section>
...
export default OrthopedicsServices;