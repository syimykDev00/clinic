...
const urologyPriceList = () => {
    ...
    return (
        <section id="urologyPriceList">
            <div className="container">
                <div className="urologyPriceList">
                    <h1>Прайс-лист</h1>
                    <p>
                        Доступные цены для всех различных вид услуг
                    </p>
                    <div className="urologyPriceList--blocks">
                        <div className="urologyPriceList--blocks__price">
                            {
                                date.map((el) => (
                                    <div className="urologyPriceList--blocks__price--block">
                                        <h4>{el.id}. {el.text}
                                        ...
                                        <div className="urologyPriceList--blocks__price--block__line"></div>
                                        <h5>{el.price}</h5>
                                    </div>
                        ...
                        <div className="urologyPriceList--blocks__image">
                            <img src={therapyPriceListImg} alt="img"/>
                            <div className="urologyPriceList--blocks__image--text">
...
export default urologyPriceList;